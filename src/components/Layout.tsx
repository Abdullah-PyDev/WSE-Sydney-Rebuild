        ...
        <Link to="/" className="flex items-center gap-3 group">
          <div className="h-14 flex items-center justify-center overflow-hidden min-w-[120px]">
            ...
            <div className="fallback-text hidden flex-col">
              ...
              <span className="text-[8px] font-bold text-outline uppercase tracking-[0.2em] mt-1">Precision Estimating</span>
            </div>
          </div>
        </Link>
...
export const Footer = () => {
  return (
    <footer className="w-full bg-surface-container-lowest text-on-surface-variant pt-20 pb-10 border-t border-outline-variant">
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
        {/* Brand & Mission */}
        <div className="md:col-span-4 flex flex-col space-y-6">
          <Link to="/" className="flex items-center gap-3">
            <div className="h-12 flex items-center justify-center overflow-hidden bg-surface-container-low rounded-md p-1 px-3 border border-outline-variant">
              <img 
                src="/logo.png" 
                alt="WSE Sydney" 
                className="h-full w-auto object-contain"
          ...
          <div className="flex gap-4">
            <a href="#" className="p-2 bg-surface-container rounded-full hover:bg-primary hover:text-on-primary transition-all">
              <Linkedin size={18} />
            </a>
            <a href="#" className="p-2 bg-surface-container rounded-full hover:bg-secondary hover:text-on-secondary transition-all">
              <Twitter size={18} />
            </a>
            <a href="#" className="p-2 bg-surface-container rounded-full hover:bg-primary-container hover:text-on-primary-container transition-all">
              <Facebook size={18} />
            </a>
          </div>
        </div>
        ...
        <div className="md:col-span-2">
          <h5 className="text-on-surface font-headline font-bold text-sm uppercase tracking-widest mb-8">Navigation</h5>
        ...
        <div className="md:col-span-3">
          <h5 className="text-on-surface font-headline font-bold text-sm uppercase tracking-widest mb-8">Core Services</h5>
          <ul className="space-y-4 text-sm">
        ...
        {/* Contact Info */}
        <div className="md:col-span-3">
          <h5 className="text-on-surface font-headline font-bold text-sm uppercase tracking-widest mb-8">Contact Us</h5>
      ...
      {/* Bottom Bar */}
      <div className="max-w-7xl mx-auto px-8 pt-10 border-t border-outline-variant">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-xs text-outline">
