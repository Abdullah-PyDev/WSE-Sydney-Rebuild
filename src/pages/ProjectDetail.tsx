    ...
    <main className="pt-20">
      ...
      <section className="relative bg-primary py-24 px-8 overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <div className="absolute inset-0 bg-gradient-to-br from-primary via-primary-container to-surface-tint"></div>
          <img 
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <Link to="/services" className="inline-flex items-center gap-2 text-surface-tint font-bold text-[10px] uppercase tracking-[0.3em] mb-8 hover:text-white transition-colors font-headline">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
            <div>
              ...
              <div className="flex flex-wrap gap-6 text-white/70 text-sm font-body">
                <div className="flex items-center gap-2">
                  <MapPin size={16} className="text-surface-tint" /> {project.location}
                </div>
                <div className="flex items-center gap-2">
                  <Calendar size={16} className="text-surface-tint" /> {project.date}
                </div>
              </div>
            </div>
            <motion.div 
              ...
              className="bg-white/10 backdrop-blur-md p-8 border-l-4 border-surface-tint shadow-xl rounded-r-xl"
            >
              <p className="text-white/50 text-[10px] font-bold uppercase tracking-widest mb-2 font-body">Project Status</p>
              <p className="text-white font-bold text-2xl font-headline">Completed & Verified</p>
            </motion.div>
          </div>
        </div>
